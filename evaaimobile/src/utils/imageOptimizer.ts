...
export class ImageOptimizer {
  ...
  private getOptimizedPath(inputPath: string): string {
...
export async function optimizeForWeb(imagePath: string, outputPath?: string) {
...
export async function createThumbnail(imagePath: string, outputPath?: string) {
  const optimizer = new ImageOptimizer({
    quality: 70,
    maxWidth: 300,
    maxHeight: 300,
...
export async function optimizeForMobile(imagePath: string, outputPath?: string) {
  const optimizer = new ImageOptimizer({
    quality: 65,
    maxWidth: 800,
    maxHeight: 600,
